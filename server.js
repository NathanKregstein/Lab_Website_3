...
app.get('/player_info/post', function(req,res){
	var tempid = req.query.player_choice
var query2 = 'select id, name from football_players;';
var query3 = 'select * from football_players WHERE id =' + tempid + ";";
var query4 = 'SELECT  COUNT(*) FROM football_players INNER JOIN football_games ON football_players.id = ANY(football_games.players) WHERE football_players.id = ' + tempid + ";";
db.task('get-everything', task => {
    return task.batch([
        task.any(query2),
        task.any(query3),
